...
<section>
  ...
  <div class="modal-dialog">
    ...
    <form method="post" action="{{route('approve-issue')}}">
        @csrf
      ...
      <div class="modal-body modal-body-custom">
          ...
          <div class="mb-3">
            ...
            <input value="{{$issueDetails->id}}" type="hidden" name="issueID">
            <textarea class="form-control form-control-custom" name="comment"></textarea>
          </div>
        
      </div>
      <div class="modal-footer modal-footer-custom">
        <button type="button" class="btn btn-sm btn-danger px-4" data-bs-dismiss="modal">না</button>
        <button type="submit" class="btn btn-sm btn-success px-4">হ্যাঁ</button>
      </div>
    </div>
    </form>
  </div>
...
<div class="modal fade" id="rejectedModal" tabindex="-1" aria-labelledby="rejectedModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content col-box">
    <form method="post" action="{{route('reject-issue')}}">
        @csrf
      <div class="modal-header modal-header-confirmation">
